...
test-unit: export SHADOW_NS_REGEXP := ^(?!status-im\.integration-test|?!status-im\.contract-test).*-test$$
...
test-integration: export SHADOW_NS_REGEXP := ^status-im\.tests\.integration-test.*$$
...
test-contract: export SHADOW_NS_REGEXP := ^status-im\.tests\.contract-test.*$$
