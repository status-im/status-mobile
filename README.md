![Status - A Browser, Messenger, and gateway to the decentralized world of Ethereum](https://status.im/img/status-github-banner@2x.png?v=1.1 "Status - A Browser, Messenger, and gateway to the decentralized world of Ethereum")
// TODO badges
...
- **Testers**  
It's bug hunting season! Status is currently in Alpha, so [grab your fresh copy of Status](http://TODO) and shake your phone to submit bug reports.  Start browsing our [Github Issues](http://github.com/status-im/status-react/issues). Every bug you find brings Status closer to stable, usable software for everyone to enjoy!
