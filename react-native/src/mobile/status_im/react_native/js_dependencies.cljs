...
(defn secure-random []      (.-generateSecureRandom ^js (securerandom)))
(def fetch-polyfill         (js-require/js-require "react-native-fetch-polyfill"))
(defn fetch []              (.-default ^js (fetch-polyfill)))
(def i18n                   (js/require "i18n-js"))
(def react-native-languages (.-default ^js (js/require "react-native-languages")))
...
(defn background-timer []   (.-default ^js (background-timer-class)))
...
(defn react-native-mail []  (.-default ^js (mail-class)))
