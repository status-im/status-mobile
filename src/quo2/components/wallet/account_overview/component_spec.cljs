    ...
    (h/test "renders correct account timeframe"
      (h/render [account-overview/view
                 {:time-frame        :one-week
                  :currency-change   "€0.00"
                  :percentage-change "0.00%"}])
      (h/is-truthy (h/get-by-text (h/get-by-translation-text :t/one-week-int))))
    ...
    (h/test "renders correct account timeframe"
      (h/render [account-overview/view
                 {:time-frame        :one-month
                  :currency-change   "€0.00"
                  :percentage-change "0.00%"}])
      (h/is-truthy (h/get-by-text (h/get-by-translation-text :t/one-month-int))))
    ...
    (h/test "renders correct account timeframe"
      (h/render [account-overview/view
                 {:time-frame        :three-months
                  :currency-change   "€0.00"
                  :percentage-change "0.00%"}])
      (h/is-truthy (h/get-by-text (h/get-by-translation-text :t/three-months-int))))
    ...
    (h/test "renders correct account timeframe"
      (h/render [account-overview/view
                 {:time-frame        :one-year
                  :currency-change   "€0.00"
                  :percentage-change "0.00%"}])
      (h/is-truthy (h/get-by-text (h/get-by-translation-text :t/one-year))))
    ...
    (h/test "renders correct account timeframe"
      (h/render [account-overview/view
                 {:time-frame        :all-time
                  :currency-change   "€0.00"
                  :percentage-change "0.00%"}])
      (h/is-truthy (h/get-by-text (h/get-by-translation-text :t/all-time))))))
