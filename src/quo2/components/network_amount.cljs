(ns quo2.components.network-amount
...
(defn network-amount
  ...
  [{:keys [style network-name icon eth-value] :as _opts}]
  [rn/view (merge {:accessibility-label :network-amount
   ...
   [rn/view {:style {:flex-direction :row :align-items :center}}
    [rn/view {:flex-direction :column :align-self :flex-start :padding-top 3 :padding-right 4}
     [icon/icon icon {:size 12 :color :none}]]
    [rn/view
     [rn/view {:style {:flex-direction :row :align-items :center}}
      ...
      [rn/view {:style {:border-right-width 1
                        ...
                        :align-self :center
                        :height 8}}]]
     [text/text {:weight :medium :size :label :style {:color colors/neutral-50}}
