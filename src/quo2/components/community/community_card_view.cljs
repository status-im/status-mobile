...
(defn community-card-view-item
  ...
  [rn/touchable-opacity {:on-press on-press}
   [rn/view {:style (merge (styles/community-card 20)
                           {:margin-bottom 16}
                           (if featured
                             {:margin-right 12}
                             {:flex              1
    ...
    [rn/view {:style    {:height        230
     ...
     [rn/view
      {:flex 1}
      [rn/view (styles/community-cover-container 40)
       [rn/image
        {:source cover
         :style
         {:flex          1
          :border-radius 20}}]]
      [rn/view (styles/card-view-content-container 12)
       [rn/view (styles/card-view-chat-icon 48)]
       ...
       [rn/view {:style (styles/card-stats-position)}
        [community-view/community-stats-column :card-view]]
       [rn/view {:style (styles/community-tags-position)}
