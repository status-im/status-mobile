...
(def translations
  {
   ...
   :send-transaction                      "Отправить трансакцию"
   ...
   :here-is-your-signing-phrase           "Вот ваша фраза подписи. Вы будете использовать ее для проверки достоверности своих трансакций. *Запишите ее и храните в безопасности!*"
   ...
   :unsigned-transaction-expired          "Неподписанная трансакция истекла"
   :status                                "Status"
   ...
   :confirmations-helper-text             "Пожалуйста, подождите как минимум 12 подтверждений, чтобы убедиться, что трансакция обработана безопасно"
   :copy-transaction-hash                 "Копировать трансакционный хеш"
   ...
   :signing-phrase-description            "Подпишите трансакцию, введя свой пароль. Убедитесь, что слова выше соответствуют вашей секретной фразе подписи"
   :wallet-insufficient-funds             "Недостаточно средств"
   :request-transaction                   "Запрос трансакции"
   ...
   :transaction-details                   "Детали трансакции"
   :transaction-failed                    "Не удалось выполнить трансакцию"
   :transactions-sign                     "Подписать"
   :transactions-sign-all                 "Подписать все"
   :transactions-sign-transaction         "Подписать трансакцию"
   :transactions-sign-later               "Подписать позже"
   :transactions-delete                   "Удалить трансакцию"
   :transactions-delete-content           "Трансакция будет удалена из списка 'Неподписанные'"
   :transactions-history                  "История"
   :transactions-unsigned                 "Неподписанные"
   :transactions-history-empty            "В вашей истории еще нет трансакций"
   :transactions-unsigned-empty           "У вас нет никаких неподписанных трансакций"
   ...
   :view-transaction-details              "Посмотреть детали трансакций"
   :transaction-description               "Пожалуйста, подождите как минимум 12 подтверждений, чтобы убедиться, что трансакция обработана безопасно"
   :transaction-sent                      "Трансакция отправлена"
   :transaction-moved-text                "Трансакция будет находится в списке 'Неподписанные' в течение 5 минут"
   :transaction-moved-title               "Трансакция перемещена"
   :sign-later-title                      "Подписать трансакцию позже?"
   :sign-later-text                       "Откройте историю транзакций, чтобы подписать эту трансакцию"
   :not-applicable                        "Не применимо для неподписанных трансакций"
