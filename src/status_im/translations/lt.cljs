...
(def translations
  {
   ...
   :testnet-text                          "Jūs esate testiniame tinkle {{testnet}}. Nesiųskite tikru ETH arba SNT i jūsų adresą"
   ...
   :copy-transaction-hash                 "Copijuoti sandėrio hash"
   ...
   :testfairy-message                     "Naudojate programą, įdiegtą iš naktinio kūrimo. Testavimo tikslais šiame kūrime įrašomas seansas, jei naudojamas "Wi-Fi" ryšys, taigi visa sąveika su programa išsaugoma (kaip vaizdo įrašas ir žurnalas) ir gali būti naudojama kūrimo komanda, kad ištirtų galimus klausimus. Išsaugotas vaizdo įrašas / žurnalas neįtraukia slaptažodžių. Įrašymas atliekamas tik tada, jei programa yra įdiegta iš naktinio kūrimo. Nieko nėra įrašyta, jei programa įdiegta iš "PlayStore" arba "TestFlight""
   ...
   :transactions-delete-content           "Sandoris bus pašalinta iš nepasirašytų sarašo"
   ...
   :transaction-sent                      "Sandėris išsiūstas"
