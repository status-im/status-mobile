...
(def translations
  {
   ...
   :phew-here-is-your-passphrase          "*Уф* это было непросто, вот ваша парольная фраза, *запишите ее и сохраните в надежном месте!* Вам нужно восстановить свой аккаунт."
   :here-is-your-passphrase               "Вот ваша парольная фраза, *запишите ее и сохраните в надежном месте!* Вам нужно восстановить свой аккаунт."
   ...
   :discovery                             "Поиск"
   :none                                  "Нет"
   :search-tags                           "Введите свои ярлыки поиска сюда"
