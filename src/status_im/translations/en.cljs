...
(def translations
  {
   ...
   :confirmations-helper-text             "If you want to be sure your transaction has been securely processed, wait for 12 confirmations"
   ...
   :transaction-description               "If you want to be sure your transaction has been securely processed, wait for 12 confirmations"
   :transaction-sent                      "Transaction sent"
   :transaction-moved-text                "The transaction has been moved to the 'Unsigned' list. It will be deleted after 5 minutes."
