...
(def translations
  {
   ...
   :debug-enabled                         "Debug server has been launched! Your IP address is {{ip}}. You can now add your DApp by running *status-dev-cli add --ip {{ip}}* from your computer"
   :debug-enabled-no-ip                   "Debug server has been launched! You can now add your DApp by running *status-dev-cli add --ip [your ip]* from your computer"
