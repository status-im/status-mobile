...
(def translations
  {
   ...
   :phew-here-is-your-passphrase          "*Wow* eso estuvo difícil, aquí tienes tu contraseña, 
   :here-is-your-passphrase               *¡anótala y mantenla segura!* La necesitarás para recuperar tu cuenta."
   :written-down                          "Aquí tienes tu frase de contraseña, *¡Anótala y mantenga segura!* La necesitarás para recuperar tu cuenta."
   :phone-number-required                 "Asegúrate de haberla anotado en un lugar seguro""Pulsa aquí para ingresar tu número telefónico y yo encontraré a tus amigos"
