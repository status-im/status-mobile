...
(def translations
  {
   ...
   :not-implemented                       "!не впроваджено"
   ...
   :status-pending                        "Висячий"
   :status-sent                           "Надіслано"
   :status-seen-by-everyone               "Всі переглянули"
   :status-seen                           "Переглянуто"
   :status-delivered                      "Доставлено"
   :status-failed                         "Не вдалось"
   ...
   :confirmation-code                     (str "Дякуємо! Ми відправили вам текстове повідомлення з кодом "
                                               "підтвердженням. Будь ласка, надайте цей код, щоб підтвердити свій номер телефону")
   ...
   :account-generation-message            "Дайте мені секунду, потрібно вирішити багато математичних задач, щоб створити ваш обліковий запис!"
   ...
   :discovery                             "Відкриття"
   :none                                  "Жоден"
   :search-tags                           "Введіть ваші пошукові теги тут"
   ...
   ;protocol
   :received-invitation                   "отримано запрошення в розмову"
