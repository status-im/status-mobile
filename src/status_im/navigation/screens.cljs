(ns status-im.navigation.screens
  (:require
   ...
   [status-im.contexts.profile.settings.screens.messages.link-previews.view :as settings.link-previews]
...
(def settings-screens
  [{:name      :screen/settings
   ...
   {:name      :screen/link-previews
    :metrics   {:track?   true
                :alias-id :settings.link-previews}
    :options   options/transparent-modal-screen-options
    :component settings.link-previews/view}
