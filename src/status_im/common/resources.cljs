...
(def mock-images
  {:bored-ape             (js/require "../resources/images/mock2/bored-ape.png")
   ...
   :small-oeth-card-icon  (js/require "../resources/images/mock2/small_opt_card_icon.png")
   :small-oeth-card-main  (js/require "../resources/images/mock2/small_opt_card_main.png")
