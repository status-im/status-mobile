...
(rf/defn account-creation-complete
  {:events [:onboarding/account-creation-complete]}
  [{:keys [db] :as cofx} {:keys [loading-animation-complete? loading-screen login-signal-received?]}]
  (let [loading-animation-complete? (or loading-animation-complete?
                                        (:onboarding/loading-animation-complete? db))
        loading-screen              (or loading-screen (:onboarding/loading-screen db))
        login-signal-received?      (or login-signal-received? (:onboarding/login-signal-received? db))]
