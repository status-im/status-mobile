...
(defn content-row
  ...
  {:flex-direction      :row
   ...
   :border-bottom-color (colors/theme-colors colors/neutral-20 colors/neutral-80 theme)
   :border-bottom-width (if border-bottom? 1 0)})
...
(defn token-parameter
  ...
  {:flex              1
   ...
   :border-left-color (colors/theme-colors colors/neutral-20 colors/neutral-80 theme)
   :border-left-width (if first? 0 1)
