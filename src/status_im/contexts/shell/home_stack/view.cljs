(ns status-im.contexts.shell.home-stack.view
  (:require
    ...
    [status-im.contexts.browser.view :as new-browser]
...
(defn- f-stack-view
  ...
  [reanimated/view
   ...
   (case stack-id
     ...
     :screen/browser-stack     [new-browser/view]
     [:<>])])
...
(defn view
  ...
  (let [theme (quo.context/use-theme)]
    [rn/view {:style (style/home-stack theme)}
     #_[lazy-screen :screen/communities-stack shared-values theme]
     #_[lazy-screen :screen/chats-stack shared-values theme]
     [lazy-screen :screen/browser-stack shared-values theme]
     #_[lazy-screen :screen/wallet-stack shared-values theme]
     #_[lazy-screen :screen/market-stack shared-values theme]]))
