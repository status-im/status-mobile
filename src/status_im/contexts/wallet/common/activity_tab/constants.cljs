...
(def ^:const wallet-activity-id->name {wallet-activity-type-send                :send
...
(def ^:const wallet-activity-status->name {wallet-activity-status-failed    :failed
...
(def ^:const second-tag-prefix {wallet-activity-type-send                :t/from
...
(def ^:const third-tag-prefix  {wallet-activity-type-send                :t/to
...
(def ^:const fourth-tag-prefix {wallet-activity-type-send                :t/via
