...
(def ^:const linea-chain-id 59144)
(def ^:const linea-sepolia-chain-id 59141)
...
(def ^:const chain-id-for-new-network-banner linea-chain-id)
...
(def ^:const mainnets
  {ethereum-chain-id
   ...
   linea-chain-id
   {:network-name        :linea
    :source              (resources/get-network :linea)
    :abbreviated-name    "Linea"
    :block-explorer-name "Lineascan"}})
