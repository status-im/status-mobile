(ns status-im.contexts.chat.messages.navigation.view
  (:require
    [quo.core :as quo]
    ...
    [status-im.contexts.chat.messages.constants :as messages.constants]
    [status-im.contexts.chat.messages.navigation.style :as style]
    [status-im.contexts.chat.messages.pin.banner.view :as pin.banner]
    [utils.i18n :as i18n]
