(ns status-im.contexts.syncing.scan-sync-code.view
  (:require
    ...
    [status-im.contexts.syncing.scan-sync-code.animation :as animation]
    [status-im.contexts.syncing.scan-sync-code.style :as style]
