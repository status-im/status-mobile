(ns status-im.ui.screens.contacts.new-contact.views
  ...
  (:require [re-frame.core :as re-frame]
            ...
            [status-im.components.styles :as components.styles :refer [icon-ok button-input-container button-input color-blue]]
            [status-im.components.image-button.view :as scan-button]
