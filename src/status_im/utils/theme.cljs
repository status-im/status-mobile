...
(def event-emitter nil #_(oget js-dependencies/react-native-dark-mode "eventEmitter"))
(def initial-mode nil #_(atom (oget js-dependencies/react-native-dark-mode "initialMode")))
