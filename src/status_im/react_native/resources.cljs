...
(def ui
  {:empty-hashtags          (js/require "./resources/images/ui/empty-hashtags.png")
   ...
   :main-icons/private-chat (js/require "./resources/images/group_chat.png")
   :main-icons/group-chat   (js/require "./resources/images/private_chat.png")
   :main-icons/public-chat  (js/require "./resources/images/public_chat.png")
   :main-icons/qr           (js/require "./resources/images/qr.png")
   :main-icons/share        (js/require "./resources/images/share.png")
