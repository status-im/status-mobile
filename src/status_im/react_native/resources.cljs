...
(def ui
  {:empty-chats-header (js/require "../resources/images/ui/empty-chats-header.png")
   ...
   :dummy-qr           (js/require "../resources/images/ui/dummy-qr.png")
   :share-icon         (js/require "../resources/images/ui/share-icon20.png")
   :customize-icon     (js/require "../resources/images/ui/customize-icon20.png")
   :zksync             (js/require "../resources/images/ui/zksync.png")
   :network-share      (js/require "../resources/images/ui/network-share.png")
   :ethereum           (js/require "../resources/images/ui/ethereum.png")
   :arbitrum           (js/require "../resources/images/ui/arbitrum.png")
   :hermez             (js/require "../resources/images/ui/hermez.png")
   :optimism           (js/require "../resources/images/ui/optimism.png")
   :copy-icon          (js/require "../resources/images/ui/copy-icon20.png")
