...
#_(h/deftest-sub :communities/section-list
    [sub-name]
...
#_(h/deftest-sub :communities/unviewed-counts
    [sub-name]
...
#_(h/deftest-sub :communities/categorized-channels
    [sub-name]
...
#_(h/deftest-sub :communities/my-pending-requests-to-join
    [sub-name]
    (testing "no requests"
      (swap! rf-db/app-db assoc
...
#_(h/deftest-sub :communities/my-pending-request-to-join
    [sub-name]
...
#_(h/deftest-sub :community/token-gated-overview
    [sub-name]
    (let
...
#_(h/deftest-sub :communities/airdrop-account
    [sub-name]
...
#_(h/deftest-sub :communities/selected-permission-accounts
    [sub-name]
...
#_(h/deftest-sub :community/token-permissions
    [sub-name]
    (testing "returns token permissions grouped by type with correct attributes"
      (swap! rf-db/app-db assoc
        :communities
...
(h/deftest-sub :community/token-permissions-2
  [sub-name]
  (testing "returns token permissions grouped by type with correct attributes"
    (swap! rf-db/app-db assoc
      :communities
