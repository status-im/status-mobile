...
(defn mock
  ...
  (case module
    ...
    "../src/worklets/js/core.js"                    worklet-factory
    "../src/worklets/js/shell.js"                   #js {}
    "../src/worklets/js/bottom_sheet.js"            #js {}
    "../src/worklets/js/record_audio.js"            #js {}
    "../src/worklets/js/scroll_view.js"             #js {}
