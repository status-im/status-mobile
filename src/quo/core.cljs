(ns quo.core
  ...
  (:require
    ...
    quo.components.browser.dapp-favorites.view
    quo.components.browser.dapp-item.view
    quo.components.browser.new-tab.view
...
(def dapp-favorites quo.components.browser.dapp-favorites.view/view)
(def dapp-item quo.components.browser.dapp-item.view/view)
(def new-tab quo.components.browser.new-tab.view/view)
