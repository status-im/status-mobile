(ns quo.components.wallet.progress-bar.component-spec
  (:require
    [quo.components.wallet.progress-bar.view :as progress-bar]
    ...
    (let [theme :light
      ...
      (h/has-style (h/query-by-label-text :progress-bar)
                   {:height          12
                    ...
                    :borderRadius    3
                    :borderColor     colors/neutral-80-opa-5
                    :backgroundColor (colors/resolve-color (:customization-color props) 50)})))
    ...
    (let [theme :dark
      ...
      (h/has-style (h/query-by-label-text :progress-bar)
                   {:height          12
                    ...
                    :borderRadius    3
                    :borderColor     colors/neutral-80-opa-5
                    :backgroundColor (colors/resolve-color (:customization-color props) 60)})))
    ...
    (let [theme :light
      ...
      (h/has-style (h/query-by-label-text :progress-bar)
                   {:height          12
                    ...
                    :borderRadius    3
                    :borderColor     colors/neutral-80-opa-5
                    :backgroundColor (colors/resolve-color :success 50)})))
    ...
    (let [theme :light
      ...
      (h/has-style (h/query-by-label-text :progress-bar)
                   {:height          12
                    ...
                    :borderRadius    3
                    :borderColor     colors/neutral-80-opa-5
                    :backgroundColor (colors/resolve-color :danger 50)})))
    ...
    (let [theme :dark
      ...
      (h/has-style (h/query-by-label-text :progress-bar)
                   {:height          12
                    ...
                    :borderRadius    3
                    :borderColor     colors/white-opa-5
                    :backgroundColor (colors/resolve-color :danger 60)}))))
