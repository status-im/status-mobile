...
(def ^:private icons
  {:i/clear-20         (memoize clear-20)
   :i/dropdown-20      (memoize dropdown-20)
   :i/pullup-20        (memoize pullup-20)
   :i/dropdown-12      (memoize dropdown-12)
   :i/pullup-12        (memoize pullup-12)
   :i/contact-12       (memoize contact-12)
   :i/contact-20       (memoize contact-20)
   :i/verified-20      (memoize verified-20)
   :i/untrustworthy-20 (memoize untrustworthy-20)})

(defn- append-to-keyword
  [k & xs]
  (keyword (apply str (subs (str k) 1) xs)))
