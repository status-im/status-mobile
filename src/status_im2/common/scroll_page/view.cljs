...
(defn scroll-page-header
  [scroll-height height name page-nav cover sticky-header top-nav title-colum navigate-back?]
...
(defn scroll-page
  ...
  (let [scroll-height (reagent/atom negative-scroll-position-0)]
    (fn [{:keys [name cover-image page-nav-right-section-buttons on-scroll
