...
(def parallax-video
  {:biometrics    [(js/require "../resources/videos2/Biometrics_Layer_01_FullRes_1.mp4")
                   (js/require "../resources/videos2/Biometrics_Layer_02_FullRes_1.mp4")
                   (js/require "../resources/videos2/Biometrics_Layer_03_FullRes_1.mp4")
                   (js/require "../resources/videos2/Biometrics_Layer_04_FullRes_1.mp4")]

   :biometrics1    [(js/require "../resources/videos2/biometrics_layer_01_copy.mp4")
                    (js/require "../resources/videos2/Biometrics_Layer_02_2_copy.mp4")
                    (js/require "../resources/videos2/Biometrics_Layer_03_2_copy.mp4")
                    (js/require "../resources/videos2/Biometrics_Layer_04_2_copy.mp4")]

   :biometrics2   [(js/require "../resources/videos2/biometrics_layer_01_copy.mp4")
                   (js/require "../resources/videos2/Biometrics_Layer_02_3_copy.mp4")
   ...
   :generate-keys [(js/require "../resources/videos2/generating_keys_layer_01_copy.mp4")
                   ...
                   (js/require "../resources/videos2/Generating_Keys_Layer_03_1_copy.mp4")]

   :generate-keys1 [(js/require "../resources/videos2/generating_keys_layer_01_copy.mp4")
                    (js/require "../resources/videos2/generating_keys_layer_02_copy.mp4")
                    (js/require "../resources/videos2/Generating_Keys_Layer_03_2_copy.mp4")]

   :generate-keys2 [(js/require "../resources/videos2/generating_keys_layer_01_copy.mp4")
                    (js/require "../resources/videos2/generating_keys_layer_02_copy.mp4")
                    (js/require "../resources/videos2/Generating_Keys_Layer_03_3_copy.mp4")]})
