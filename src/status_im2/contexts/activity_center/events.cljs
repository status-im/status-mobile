...
(urf/defn process-notification-failure
...
(urf/defn notifications-reconcile
...
(urf/defn notifications-reconcile-from-response
...
(urf/defn contact-verification-decline
...
(urf/defn contact-verification-reply
...
(urf/defn contact-verification-mark-as-trusted
...
(urf/defn contact-verification-mark-as-untrustworthy
...
(urf/defn notifications-fetch-first-page
...
(urf/defn notifications-fetch-next-page
...
(urf/defn notifications-fetch-success
...
(urf/defn notifications-fetch-unread-contact-requests
...
(urf/defn notifications-fetch-unread-count
