...
(defn view
  ...
  (let [current-component (reagent/current-component)
        ...
        ;; Some components add JS props to their children (such as TouchableWithoutFeedback), to
        ;; make this component fully compatible we are passing those props to the inner component
        ;; (`view*`).
