...
public class NimStatus {
  ...
  public native String exportUnencryptedDatabase(String accountData, String password, String path);
  public native String importUnencryptedDatabase(String accountData, String password, String path);
}
